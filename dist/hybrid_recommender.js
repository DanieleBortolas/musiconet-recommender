...
function getHybridRecommendations(db_1, user_id_1) {
    return __awaiter(this, arguments, void 0, function* (db, user_id, nEvents = 10, kNeighbors = 20, alpha = 0.5) {
        ...
        const cfResults = yield collaborative_filtering_js_1.default.getCollaborativeFilteringRecommendations(db, user_id, nEvents * 2, kNeighbors);
